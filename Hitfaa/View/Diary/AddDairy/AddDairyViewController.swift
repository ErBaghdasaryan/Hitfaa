...
class AddDairyViewController: BaseViewController {
...
extension AddDairyViewController: IViewModelableController {
    typealias ViewModel = IAddDairyViewModel
}

//MARK: Progress View
extension AddDairyViewController {
    private func makeButtonActions() {
        backButton.addTarget(self, action: #selector(backTapped), for: .touchUpInside)
        delete.addTarget(self, action: #selector(backTapped), for: .touchUpInside)
    ...
    @objc func saveDairy() {
        ...
        self.viewModel?.addDairy(model: .init(title: title,
                                              text: text,
                                              year: formattedDate))
...
extension AddDairyViewController: UITextFieldDelegate, UITextViewDelegate {
...
struct AddDairyViewControllerProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context: UIViewControllerRepresentableContext<AddDairyViewControllerProvider.ContainerView>) -> AddDairyViewController {
            return addDairyViewController
        }

        func updateUIViewController(_ uiViewController: AddDairyViewControllerProvider.ContainerView.UIViewControllerType, context: UIViewControllerRepresentableContext<AddDairyViewControllerProvider.ContainerView>) {
        }
    }
}
